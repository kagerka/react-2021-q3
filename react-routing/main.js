...
function SearchOptions(_ref) {
  var searchValue = _ref.searchValue,
      setPhotoList = _ref.setPhotoList,
      pagesTotal = _ref.pagesTotal,
      setPagesTotal = _ref.setPagesTotal,
      sortBy = _ref.sortBy,
      page = _ref.page,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 2;
              _context.next = 5;
              return api.get("/rest/?method=flickr.photos.search&text=".concat(searchValue, "&sort=").concat(sortBy, "&page=").concat(page, "&per_page=").concat(perPage));

            case 5:
              response = _context.sent;
              setPhotoList((_response$data$photos = response.data.photos) === null || _response$data$photos === void 0 ? void 0 : _response$data$photos.photo);
              setPagesTotal((_response$data$photos2 = response.data.photos) === null || _response$data$photos2 === void 0 ? void 0 : _response$data$photos2.pages);
              _context.next = 13;
              break;
  ...
  var prevPage = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2() {
      var _response$data$photos3, _response$data$photos4, response;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 2;
              _context2.next = 5;
              return api.get("/rest/?method=flickr.photos.search&text=".concat(searchValue, "&sort=").concat(sortBy, "&page=").concat(+page - ONE, "&per_page=").concat(perPage));

            case 5:
              response = _context2.sent;
              setPhotoList((_response$data$photos3 = response.data.photos) === null || _response$data$photos3 === void 0 ? void 0 : _response$data$photos3.photo);
              setPagesTotal((_response$data$photos4 = response.data.photos) === null || _response$data$photos4 === void 0 ? void 0 : _response$data$photos4.pages);
              _context2.next = 13;
              break;
  ...
  var nextPage = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3() {
      var _response$data$photos5, _response$data$photos6, response;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 5:
              ...
              setPhotoList((_response$data$photos5 = response.data.photos) === null || _response$data$photos5 === void 0 ? void 0 : _response$data$photos5.photo);
              setPagesTotal((_response$data$photos6 = response.data.photos) === null || _response$data$photos6 === void 0 ? void 0 : _response$data$photos6.pages);
              _context3.next = 13;
              break;
...
SearchOptions.propTypes = {
  searchValue: prop_types.string,
  setPhotoList: prop_types.func,
  pagesTotal: prop_types.number,
  setPagesTotal: prop_types.func,
  sortBy: prop_types.string,
  setPage: prop_types.func,
  page: prop_types.string,
  perPage: prop_types.string,
  setPerPage: prop_types.func
};
...
function SearchResult(_ref) {
  var photoList = _ref.photoList,
      ...
      perPage = _ref.perPage,
      setPerPage = _ref.setPerPage;
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(searchOptions_SearchOptions, {
  ...
  }, photoList === null || photoList === void 0 ? void 0 : photoList.map(function (_ref2, index) {
    var title = _ref2.title,
        ownername = _ref2.ownername,
        dateupload = _ref2.dateupload,
        url_s = _ref2.url_s,
        views = _ref2.views,
        id = _ref2.id;
    return /*#__PURE__*/react.createElement("div", {
...
function Search() {
  ...
  var _useState5 = (0,react.useState)([]),
      ...
      photoList = _useState6[0],
      setPhotoList = _useState6[1];

  var _useState7 = (0,react.useState)(ZERO),
      _useState8 = _slicedToArray(_useState7, 2),
      pagesTotal = _useState8[0],
      setPagesTotal = _useState8[1];

  var _useState9 = (0,react.useState)('date-posted-desc'),
  ...
  var _useState13 = (0,react.useState)('10'),
  ...
  var _useState15 = (0,react.useState)(true),
      ...
      beforeSearch = _useState16[0],
      setBeforeSearch = _useState16[1];
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 4;
              _context.next = 7;
              return api.get("/rest/?method=flickr.photos.search&text=".concat(searchValue, "&sort=").concat(sortBy, "&page=1&per_page=10"));
  ...
  return /*#__PURE__*/react.createElement(animated.div, {
  ...
  }, isLoading ? 'Loading...' : 'Search'))), pagesTotal !== ZERO && /*#__PURE__*/react.createElement(searchResult_SearchResult, {
    photoList: photoList,
    searchValue: searchValue,
    setPhotoList: setPhotoList,
    pagesTotal: pagesTotal,
    ...
    perPage: perPage,
    setPerPage: setPerPage
  }), pagesTotal === ZERO && beforeSearch && /*#__PURE__*/react.createElement(searchInfo_SearchInfo, null), pagesTotal === ZERO && searchValue !== '' && !beforeSearch && /*#__PURE__*/react.createElement(error_NotFound, null), isLoading ? /*#__PURE__*/react.createElement(loading_Loading, null) : null);
}
...
var getImage = axios_default().create({
  ...
  params: {
    nojsoncallback: 1,
    format: 'json',
    api_key: API_KEY // auth_token: '72157719716571657-daefb401a9878aa1',
...
var Details = function Details() {
  ...
  return /*#__PURE__*/react.createElement("div", null, isLoading ? /*#__PURE__*/react.createElement(loading_Loading, null) : /*#__PURE__*/react.createElement("div", {
...
Details.propTypes = {
  url_o: prop_types.string,
  location: prop_types.object
};
